                ...
                <div className='mb-0 px-6 lg:px-8'>
                  <div className='mx-auto max-w-2xl sm:text-center'>
                    ...
                    <p className='text-lg mt-4 text-justify text-gray-600 mb-12'>
                      ...
                      proporcionando una evaluación precisa del estado de los materiales. Esto permite una i
                      dentificación temprana de problemas potenciales, lo que a su vez facilita la planificación 
